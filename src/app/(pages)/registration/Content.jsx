          ...
          <Tabs defaultValue="physical" className="w-full" onValueChange={setActiveTab}>
            <div className="flex justify-center mb-10">
              <TabsList className="bg-gray-100 p-1 rounded-full">
                <TabsTrigger
                  value="physical"
                  className="rounded-full data-[state=active]:bg-neutral-700 text-md data-[state=active]:text-white px-6 py-2"
                >
            ...
            <TabsContent value="custom" className="mt-0">
              ...
              <div className="max-w-md mx-auto">
                <div className="bg-white rounded-3xl border  overflow-hidden shadow-sm">
                  <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-6">
                    <div className="flex justify-between items-center">
                      <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-neutral-700 text-md text-white">
                        Custom Payment
                      </span>
