...
export function RegistrationCard({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gray=5-/50 rounded-3xl blur-xl opacity-70 group-hover:opacity-100 transition-opacity"></div>
      ...
      <div className="relative bg-white rounded-3xl border border-[#d3e4c5] overflow-hidden h-full transition-all shadow-sm">
        ...
        <div className="relative p-8 flex flex-col h-full">
          <div className="flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 p-0.5 -mt-4 mb-6 shadow-lg">
