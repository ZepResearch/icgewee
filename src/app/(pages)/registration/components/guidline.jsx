  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      ...
      <CardContent className="space-y-6">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 md:gap-6">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-bl from-sky-400 via-rose-400 to-lime-400 text-primary-foreground font-bold text-lg flex-shrink-0">
                    {step.number}
                  </div>
        ...
        <div className="mt-8 p-4 bg-muted/50 rounded-lg border-l-4 border-rose-500">
