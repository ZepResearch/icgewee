      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-md">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Your journal has been successfully submitted to the ICGEWEE.
          </p>
        </div>
        <div className="mt-6">
          ...
          <div className="mt-6 text-center">
            <Link
              href="/"
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-tr from-sky-400 via-rose-400 to-lime-400  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1a5276]"
            >
              Return to Homepage
            </Link>
          </div>
