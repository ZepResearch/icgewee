...
export default function PaperSubmissionForm({ journalId, journalTitle }) {
  ...
  return (
    <Card className="shadow-lg border-0 overflow-hidden bg-slate-50">
      <div className="h-2 bg-gradient-to-l from-sky-400 via-rose-400 to-lime-400 "></div>

      <CardHeader className="space-y-1 pb-6 pt-6">
        <CardTitle className="text-2xl font-bold tracking-tight bg-gradient-to-r from-gray-800 to-gray-900 bg-clip-text text-transparent">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 ">
              ...
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed border-muted rounded-lg p-4 text-center transition-colors hover:bg-muted/5">
                  ...
                  <label htmlFor="file" className="cursor-pointer flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">DOC or DOCX only (max 10MB)</span>
                  </label>
                </div>
              </div>
          ...
          <CardFooter className="flex justify-end px-0 pt-4">
            <Button
              ...
              className="bg-gradient-to-l from-sky-400 via-rose-400 to-lime-400  hover:scale-105 transition-all text-white w-full"
              size="lg"
            >
              {isSubmitting ? (
                <>
