    ...
    <div className="min-h-screen ">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-slate-50 rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {/* Title Section */}
          <div className="bg-gradient-to-tr from-sky-400 via-rose-400 to-lime-400 px-8 py-6">
          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                The  International Conference on Gender Equality, Women Empowerment & Entrepreneurship (ICGEWEE 2025) is committed to fostering an inclusive, accessible, and discrimination-free environment for all participants, regardless of physical, sensory, intellectual, or mental health conditions.
              </p>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ICGEWEE 2025 strictly prohibits any form of discrimination, harassment, or exclusion based on disability. All conference organizers, staff, and participants are expected to support and uphold the principles of inclusivity and equal access to conference activities, both in physical and virtual formats.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ICGEWEE 2025 will provide reasonable accommodations to ensure the full participation of individuals with disabilities, which may include:
              </p>
              ...
              <div className="mt-4 p-4 bg-pink-50 rounded-lg border-l-4 border-pink-500">
                <p className="text-gray-700 text-sm">
                  <strong>Note:</strong> Participants requiring accommodations are encouraged to notify the Organizing Committee in advance via info@ICGEWEE.in to ensure timely arrangements.
                </p>
              </div>
            </section>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="text-center">
            ...
            <Link href={'/contact'}>
            <div className="inline-flex items-center space-x-2 bg-pink-100 text-pink-700 px-4 py-2 rounded-lg">
