          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                The  International Conference on Gender Equality, Women Empowerment & Entrepreneurship ( 2025) is committed to fostering an inclusive, respectful, and equitable environment for all participants. This policy ensures that every attendee, including authors, presenters, delegates, session chairs, reviewers, organizers, and sponsors, is treated fairly and without any form of discrimination.
              </p>
            </div>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-1 gap-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    <UserCheck className="w-5 h-5 text-pink-400 flex-shrink-0" />
                    <span className="text-gray-700 text-sm">Organizing committees, scientific committees, reviewers, and session chairs</span>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    <Globe className="w-5 h-5 text-pink-500 flex-shrink-0" />
                    <span className="text-gray-700 text-sm">All  2025 events, including presentations, workshops, networking sessions, and social gatherings</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6"> 2025 ensures that:</p>
              ...
              <div className="grid md:grid-cols-1 gap-4">
                <div className="bg-pink-50 p-6 rounded-lg border-2 border-dashed border-pink-300">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <AlertCircle className="w-5 h-5 text-pink-500 mt-0.5 flex-shrink-0" />
                      <p className="text-gray-700 text-sm">
                        Any participant who experiences or witnesses unfair treatment, harassment, or discrimination is encouraged to report the issue to the  2025 organizing committee.
                      </p>
                    </div>
                    <div className="flex items-start space-x-3">
