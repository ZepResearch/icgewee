    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {/* Page Header */}
          <div className="bg-gradient-to-tl from-sky-400 via-rose-400 to-lime-400 px-8 py-6">
          ...
          <div className="px-8 py-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                The Organizing Committee of the International Conference on Gender Equality, Women Empowerment & Entrepreneurship
                (ICGEWEE) is committed to providing a professional, respectful, and inclusive environment for all
            ...
            {/* Section 2 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">2. Scope of the Policy</h2>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">3. Lodging a Complaint</h2>
              ...
              <div className="bg-rose-50 border-l-4 border-rose-400 p-4 rounded">
                <p className="text-gray-700">
                  <strong>Complaints should be sent via email to:</strong> info@icgewee.com

                </p>
                <p className="text-gray-700 mt-2">
                  <strong>Subject line:</strong> Formal Complaint – ICGEWEE 2025
                </p>
              </div>
            </section>
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">4. Complaint Review Process</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">5. Resolution and Outcomes</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">7. Appeals</h2>
              <p className="text-gray-700 leading-relaxed">
