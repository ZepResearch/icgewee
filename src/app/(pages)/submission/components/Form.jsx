                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          accept=".doc,.docx"
                          className="w-full px-4 py-3 bg-gray-100 shadow-2xs border  rounded-xl text-[#1a2e1a] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-neutral-900/80 file:text-gray-100  hover:file:bg-neutral-800/60"
                        />
                  ...
                  <div className="flex justify-center pt-4">
                    <button
                      ...
                      className="relative px-8 py-4 bg-gradient-to-tl from-sky-400 via-rose-400 to-lime-400  text-gray-100 shadow-2xs font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-[#edf6e1] disabled:opacity-50 disabled:cursor-not-allowed group overflow-hidden"
                    >
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="h-full w-full bg-rose-500/80 opacity-0 group-hover:opacity-50 group-hover:animate-pulse transition-all duration-1000"></div>
                      </div>
          ...
          <div className="max-w-2xl mx-auto ">
            <div className="bg-gray-50/50 shadow-2xl border-l-4 border-red-500 p-6 rounded-2xl  flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-700">If you have any trouble submitting your paper, please email us at <a href="mailto:info@icgewee.com" className="underline font-medium">info@icgewee.com</a>.</p>
              </div>
            </div>
          </div>
        </div>
