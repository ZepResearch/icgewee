export function getUserEmailTemplate(data) {
  ...
  <head>
    <meta charset="utf-8">
    <title>ICGEWEE Conference Submission Confirmation</title>
    <style>
      body {
      ...
      .header {
        background: linear-gradient(135deg, #0ea5e9 0%, #fb7185 50%, #84cc16 100%);
        color: white;
        padding: 40px 30px;
        text-align: center;
        position: relative;
    ...
    <div class="email-container">
      <div class="header">
        <div class="header-content">
          <h1 class="conference-logo">ICGEWEE</h1>
          <p class="conference-subtitle">International Conference on Gender Equality, Women Empowerment & Entrepreneurship</p>
        </div>
      </div>
      ...
      <div class="content">
        ...
        <div class="main-message">
          ...
          to the International Conference on Gender Equality, Women Empowerment & Entrepreneurship (ICGEWEE).
        </div>
        ...
        <div class="info-box">
          ...
          <ul class="info-list">
            ...
            <li>
              ...
              <span class="info-value">ICGEWEE-${new Date().getFullYear()}-${Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
            </li>
          </ul>
        </div>
        ...
        <div class="contact-section">
          ...
          <p>📧 Email: <a href="mailto:info@icgewee.com" style="color: #0ea5e9;">info@icgewee.com</a><br>
          🌐 Website: <a href="https://www.icgewee.com" style="color: #0ea5e9;">https://www.icgewee.com</a></p>
        </div>
        
        <div class="signature">
          <div class="signature-title">Best regards,</div>
          Conference Organizing Committee<br>
          ICGEWEE - International Conference on Gender Equality, Women Empowerment & Entrepreneurship<br>
          📧 info@icgewee.com
        </div>
      </div>
      
      <div class="footer">
        <p>© ${new Date().getFullYear()} ICGEWEE Conference. All rights reserved.</p>
...
export function getAdminEmailTemplate(data, fileUrl) {
  ...
  <head>
    <meta charset="utf-8">
    <title>New ICGEWEE Conference Submission</title>
    <style>
      body {
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        line-height: 1.6;
    ...
    <div class="email-container">
      <div class="header">
        <div class="header-content">
          ...
          <h1 class="header-title">ICGEWEE Conference Submission</h1>
      ...
      <div class="content">
        <div class="notification-banner">
          ...
          <div class="notification-text">A new research paper has been submitted to ICGEWEE Conference</div>
        </div>
          ...
          <table class="details-table">
            ...
            <tr>
              ...
              <td class="field-value">
                <a href="mailto:${data.email}" style="color: #0ea5e9; font-weight: 600;">${data.email}</a>
              </td>
            </tr>
            <tr>
      ...
      <div class="footer">
        <p>© ${new Date().getFullYear()} ICGEWEE Conference - Administrative System. All rights reserved.</p>
